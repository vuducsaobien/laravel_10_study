...
(16,'2025_06_02_000003_table_3',3),
(21,'2025_06_10_000001_create_table_4',4),
(23,'2025_06_10_000002_create_table_1_4',5);
...
--
-- Table structure for table `table_1_4`
--

DROP TABLE IF EXISTS `table_1_4`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `table_1_4` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL,
  `table_1_id` bigint(20) unsigned NOT NULL,
  `table_4_id` bigint(20) unsigned NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `table_1_4_table_1_id_table_4_id_unique` (`table_1_id`,`table_4_id`),
  KEY `table_1_4_table_4_id_foreign` (`table_4_id`),
  CONSTRAINT `table_1_4_table_1_id_foreign` FOREIGN KEY (`table_1_id`) REFERENCES `table_1` (`id`) ON DELETE CASCADE,
  CONSTRAINT `table_1_4_table_4_id_foreign` FOREIGN KEY (`table_4_id`) REFERENCES `table_4` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `table_1_4`
--

LOCK TABLES `table_1_4` WRITE;
/*!40000 ALTER TABLE `table_1_4` DISABLE KEYS */;
INSERT INTO `table_1_4` VALUES
(1,'table 1,4 : id 1 : table 1 id 1 : table 4 id 1',1,1,NULL,NULL),
(2,'table 1,4 : id 2 : table 1 id 1 : table 4 id 1',1,2,NULL,NULL),
(3,'table 1,4 : id 3 : table 1 id 2 : table 4 id 2',2,2,NULL,NULL),
(4,'table 1,4 : id 4 : table 1 id 3 : table 4 id 1',3,1,NULL,NULL),
(5,'table 1,4 : id 5 : table 1 id 3: table 4 id 1',3,3,NULL,NULL);
/*!40000 ALTER TABLE `table_1_4` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `table_3` (
  ...
  `table_1_id` bigint(20) unsigned DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `table_3_table_1_id_foreign` (`table_1_id`),
  CONSTRAINT `table_3_table_1_id_foreign` FOREIGN KEY (`table_1_id`) REFERENCES `table_1` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
(1,'Table 3 : id 1 : name',1),
(2,'Table 3 : id 2 : name',1),
(3,'Table 3 : id 3 : name',2),
(4,'Table 3 : id 4 : name',NULL);
...
-- Dump completed on 2025-06-10 17:30:28
